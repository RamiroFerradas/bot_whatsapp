...
exports.flujoBienvenida = exports.mensajeFlujoBienvenida = void 0;
var { addKeyword } = require("@bot-whatsapp/bot");
var { flujoAgradecimiento } = require("./agradecimiento");
exports.mensajeFlujoBienvenida = `¡Hola! Soy tu asistente automático. Estoy aquí para ayudarte con algunas consultas comunes:
...
exports.flujoBienvenida = addKeyword([
    "hola",
    "ayuda",
    "help",
    "buen dia",
